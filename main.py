...
• 公开合同：任何人都可以查看和接受
• 定向合同：只有指定的玩家可以接受
• 拒绝定向合同后，卖家需要取消合同才能解冻物品
• 接受合同后，物品会存入接受方所在星系机库
• 创建合同时物品会被冻结在中介
• 打包合同会出售空间站所有物品（除正在驾驶的舰船）
